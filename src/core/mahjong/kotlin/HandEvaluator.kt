...
fun Hand.getSequences(): List<List<Tile>> = getSet(this, ::getSequences)
...
fun Hand.getTriplets(): List<List<Tile>> = getSet(this, ::getTriplets)
...
fun Hand.getMentsu(): List<List<Tile>> = getSet(this, ::getSequences).plus(this.getTriplets())
...
fun Hand.getPairs(): List<List<Tile>> = SYMBOL_ORDER.flatMap { getPairs(this.getBySymbol(it)) }
...
fun Hand.calculateShanten(): Int {
    val tiles = this.handTiles
    val pairs = this.getPairs()
